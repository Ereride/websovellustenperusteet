...
const color_use = document.querySelector('input[type=color]')
...
const drawCircle = () => {
    ...
    const color = color_use.value
    const circle = new Circle(x,y,width/2)
    const lineColor = color_use.value
...
const drawRectangle = () => {
    ...
    const y = y_input.value
    const width = document.querySelector('div#third input').value
    const length= document.querySelector('div#fourth input').value
    const lineWidth = line_width_input.value
    const lineColor = color_use.value
    const rectangle = new Rectangle(x,y,width,length)
